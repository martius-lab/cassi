...
from learning.runners import CASSIOnPolicyRunner
...
class TaskRegistry:
    ...
    def make_alg_runner(
    ...
    ) -> Tuple[CASSIOnPolicyRunner, BaseConfig]:
        ...
        Returns:
            Tuple[CASSIOnPolicyRunner, BaseConfig]: Tuple containing the training runner and configuration instances.
        """
